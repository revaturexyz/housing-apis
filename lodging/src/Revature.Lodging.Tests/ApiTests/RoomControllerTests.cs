...
namespace Revature.Lodging.Tests.ApiTests
{
  ...
  {
    /// <summary>
    /// Unit test for try/catch block for Room Controller GetFilteredRoomsAsync.
    /// </summary>
    ...
    public async Task GetFilteredRoomsAsyncShouldReturnKeyNotFoundException()
    {
      ...
      var result = await controller.GetFilteredRoomsAsync(Guid.NewGuid(), string.Empty, 1, string.Empty, string.Empty, DateTime.Now, Guid.NewGuid(), true, true);
    ...
    public async Task PostRoomShouldCreateRoom()
    {
      ...
      mockRepo.Setup(r => r.CreateRoomAsync(It.IsAny<Lib.Models.Room>()));
    ...
    public async Task PutRoomShouldUpdateRoom()
    {
      ...
      mockRepo.Setup(r => r.UpdateRoomAsync(It.IsAny<Lib.Models.Room>()));
    ...
    public async Task GetRoomShouldReturnNotFound()
    {
      ...
      mockRepo.Setup(r => r.ReadRoomAsync(It.IsAny<Guid>()))
        .Throws(new InvalidOperationException());
    ...
    public async Task DeleteRoomShouldDelete()
    {
      ...
      mockRepo.Setup(r => r.DeleteRoomAsync(It.IsAny<Guid>()));
