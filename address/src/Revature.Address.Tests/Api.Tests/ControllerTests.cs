...
namespace Revature.Address.Tests.Api.Tests
{
  public class ControllerTests
  {
    ...
    public void ConstructorShouldConstruct()
    {
      ...
      var dataAccess = new Address.Lib.DataAccess(database, mapper, logger);
    ...
    // This test won't work until the google api consumption is decoupled from AddressLogic
    //[Fact]
    ...
    //  var mockLogger = new Mock<ILogger<AddressController>>();
    //  var mockAddressLogic = new Mock<IAddressLogic>();
    //  mockAddressLogic.Setup(mal => mal.IsInRangeAsync(It.IsAny<Address.Lib.Address>(), It.IsAny<Address.Lib.Address>(), It.IsAny<int>())).ReturnsAsync(() =>
    //  {
    //    return false;
    //  });
    ...
    //  // This test won't work until we decouple
