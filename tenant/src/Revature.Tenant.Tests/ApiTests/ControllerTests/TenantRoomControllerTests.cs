...
namespace Revature.Tenant.Tests.ApiTests.ControllerTests
{
  ...
  public class TenantRoomControllerTests
  {
    ...
    public async Task GetTenantsNotAssignedARoomShouldReturnAListofTenants()
    {
      ...
      var controller = new TenantRoomController(mockRepo.Object, mockRepo2.Object, mockLogger.Object, mockRoomService.Object, mockServiceBusSender.Object);

      // Act
      var result = await controller.GetTenantsNotAssignedRoom();
    ...
    public async Task AssignTenantShouldUpdateRoomIdAsync()
    {
      ...
      var result = await controller.AssignTenantToRoom(tenantId, roomId);
    ...
    public async Task AssignTenantShouldRejectUnknownTenantsAsync()
    {
      ...
      var result = await controller.AssignTenantToRoom(Guid.NewGuid(), Guid.NewGuid());
    ...
    public async Task GetTenantsByRoomIdShouldSucceedAsync()
    {
      ...
      var result = await controller.GetTenantsByRoomId(string.Empty, DateTime.Now);
